...
namespace WebStore.Services.Cart
{
    public class CookiesCartStore : ICartStore
    {
        ...
        public Entities.Entities.Cart Cart
        {
            get
            {
                var cookie =
                ...
                string json;
                Entities.Entities.Cart cart;
                if (cookie == null)
                {
                    cart = new Entities.Entities.Cart { Items = new List<CartItem>() };
                ...
                json = cookie;
                cart = JsonConvert.DeserializeObject<Entities.Entities.Cart>(json);
